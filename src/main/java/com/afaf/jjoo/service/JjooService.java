...
public class JjooService {
	 ...
	 */
	public List<SedeJjoo> listaSedesJjoo() {
	 ...
	 */
	public SedeJjoo getSede(SedeJjooPK sedeJjooPK) {
	 ...
	 * @param sedeJjooPK id de la sede
	 */
	public void borrarSede(SedeJjooPK sedeJjooPK) {
	 ...
	 */
	public List<TipoJjoo> listaTipoJjoo(){
	 ...
	 */
	public void salvaSede(SedeJjoo sedeJjoo) {
